...
if ($this->_gmail) {
$this->_mailer->Host = 'smtp.yandex.com';  // Gmail smtp
...
$this->_mailer->Host = 'smtp.yandex.com';  // Specify main and backup server //stmp entrant sortant
}

$this->_mailer->SMTPDebug = 0;    // Enable SMTP authentication
$this->_mailer->Username = 'contact@turktrade.ca';  // SMTP username
$this->_mailer->Password = 'MAIL_PASSWORD';  // SMTP password


$this->_mailer->addReplyTo("contact@turktrade.ca", "Recepient Name");
$this->_mailer->From = 'contact@turktrade.ca';
$this->_mailer->FromName = 'TurkTrade Contact';
...
$body .= "<table width='100%' bgcolor='#e0e0e0' cellpadding='0' cellspacing='0' border='0'>";
    ...
    $body .= "<tr><td>";
            ...
            $body .= "<table align='center' width='100%' border='0' cellpadding='0' cellspacing='0' style='max-width:650px; background-color:#fff; font-family:Verdana, Geneva, sans-serif;'>";
                ...
                $body .= "<thead>
                <tr height='80'>
                    <th colspan='4' style='background-color:#f5f5f5; border-bottom:solid 1px #bdbdbd; font-family:Verdana, Geneva, sans-serif; color:#333; font-size:34px;'>TurkTrade</th>
                </tr>
                </thead>";
